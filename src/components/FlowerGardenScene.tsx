...
const dialogueData: DialogueLine[] = [
  ...
  {
    speaker: "KIBO",
    text: "Woahh!! Iya banyak bangett, aku jadi ke inget dulu suka milihin bunga buat seseorang hahahah",
  ...
  {
    speaker: "KIBO",
    text: "Kadang aku malu sama diriku sendiri, aku hanya bisa ngasi barang barang kecil ke dia, tapi disisi lain aku pengen banget ngasi dia sesuatu yang lebih..",
    expression: "/char/kibo/sedih.PNG",
  },
  {
    speaker: "KIBO",
    text: "Itu salahsatu list yang pengen aku penuhi sih.. karna kalo dia seneng itu uda cukup bagiku",
