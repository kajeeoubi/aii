...
interface GiveFlowerSceneProps {
  onBackToMenu?: () => void;
  onNextScene: () => void;
}
...
const dialogueData: DialogueLine[] = [
  {
    speaker: "KIBO",
    badgeBg: "bg-[#bae1ff]",
    text: "Aii ini bunga yang udah kita rangkai bareng tadi, sempurna kayak kamu xixixi",
  },
];

export function GiveFlowerScene({ onBackToMenu, onNextScene }: GiveFlowerSceneProps) {
  ...
  return (
    ...
    >
      ...
      {/* Kasih Bunga Background Image */}
      <img
        src="/asset/kasih_bunga.png"
