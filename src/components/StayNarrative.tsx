...
const narrativeText =
  "Ternyata semua yang terjadi di Gallery itu adalah rencana Kibo buat ngasi surprise ke Aii\n\nAww sweet bgtt gasi hahaha";

export function StayNarrative({ onBackToMenu, onNextScene }: StayNarrativeProps) {
