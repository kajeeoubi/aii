...
interface ChapterSelectProps {
  onSelectChapter: (chapter: "ticket" | "gallery" | "galleryRoom" | "galleryMinigame" | "flowerGarden" | "flowerArrangingNarrative" | "statueRoom" | "statueMinigame" | "statueEnding") => void;
  onBackToMenu: () => void;
}
...
export function ChapterSelect({
  ...
  const chapters = [
    ...
    {
      id: "statueRoom" as const,
      number: "CHAPTER 7",
      title: "RUANG PATUNG",
      subtitle: "Melihat patung pameran",
      bgClass: "bg-[#e9d5ff]",
      borderClass: "border-[#2d2d2d]",
    },
    {
      id: "statueMinigame" as const,
      number: "CHAPTER 8",
      title: "GESER PATUNG",
      subtitle: "Menyelaraskan patung pameran",
      bgClass: "bg-[#baffc9]",
      borderClass: "border-[#2d2d2d]",
    },
    {
      id: "statueEnding" as const,
      number: "CHAPTER 9",
      title: "RUANGAN RAHASIA",
      subtitle: "Terbongkarnya rahasia pameran",
      bgClass: "bg-[#ffffba]",
      borderClass: "border-[#2d2d2d]",
    },
  ];
